...
// func queryAuctionHandlerFn(cliCtx client.Context, r *mux.Router) http.HandlerFunc {
// 	return func(w http.ResponseWriter, r *http.Request) {
...
// func queryAuctionsHandlerFn(cliCtx client.Context, r *mux.Router) http.HandlerFunc {
// 	return func(w http.ResponseWriter, r *http.Request) {
